...
\begin{abstract}
    ...
    %
    Nel primo vengono brevemente introdotti i problemi da affrontare durante lo sviluppo di strumenti antiplagio.
    %
    Nel secondo si descrivono le principali tecniche presenti in letteratura. 
    %
