...
\begin{abstract}
    ...
    La tesi è strutturata in capitoli: nel primo vengono brevemente introdotti i problemi da affrontare durante lo sviluppo di strumenti anti plagio; nel secondo si descrivono le principali tecniche presenti in letteratura. 
    %
    Nel terzo e quarto capitolo ci si addentra nell'analisi dei requisiti e nel processo d'implementazione. 
    %
