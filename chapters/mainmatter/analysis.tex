...
Infine, \texttt{KnoledgeBaseRepository} rappresenta l'interfaccia che permette il salvataggio e il recupero delle rappresentazioni dei sorgenti già precedentemente analizzati e, perciò, salvati in locale. 
...
%
Inoltre, si lascia aperta la possibilità di estendere le strategie per l'esportazione dei dati e per la creazione della configurazione, nel caso in futuro si voglia anche aggiungere un'interfaccia grafica al sistema.
