...
%
Tali indici sono successivamente impiegati nella vera e propria fase di filtraggio, in cui viene applicata una particolare metrica, ad esempio la similarità coseno, e viene utilizzato un valore di soglia per escludere coppie di sorgenti che hanno bassa similarità in accordo con la metrica scelta.

\todo{more on filtering}
