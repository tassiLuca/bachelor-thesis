...
%
In figura \Cref{img:01-winnowing-example} è presentato un esempio tratto da \cite{winnowing} in cui vengono mostrati i passi dell'algoritmo, applicati a un semplice testo in linguaggio naturale.
